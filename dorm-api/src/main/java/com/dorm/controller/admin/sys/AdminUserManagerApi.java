...
public class AdminUserManagerApi {
    ...
    @RequestMapping("list")
    @AuthRequired
    public JsonResult userList(PageView<Student> page, String mobile) {
        JsonResult result = new JsonResult(true, "0", "查询成功");
        List<Student> list = studentMapper.selectStudentList(mobile, page.getFirstResult(), page.getMaxresult());
        page.setRecords(list);
        page.setTotalrecord(studentMapper.selectStudentCount(mobile));
        result.setData(page);
        return result;
    }
    ...
    @AuthRequired
    public JsonResult apartmentManagerList(PageView<Admin> page, String mobile) {
        String kw = mobile;
        JsonResult result = new JsonResult(true, "0", "查询成功");
    ...
    @AuthRequired
    public JsonResult apartmentManagerModifyList(PageView<AdminModify> page, String mobile) {
        String kw = mobile;
        JsonResult result = new JsonResult(true, "0", "查询成功");
...
//                orgAdmin.setBuilding(admin.getBuildingId());
    ...
    @AuthRequired
    public JsonResult apartmentWorkerList(PageView<Admin> page, String mobile) {
        String kw = mobile;
        JsonResult result = new JsonResult(true, "0", "查询成功");
        Example example = new Example(Admin.class);
        Example.Criteria criteria = example.createCriteria();
